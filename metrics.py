...
def bbox_iou(box1, box2, epoch, xywh=True, GIoU=False, DIoU=False, CIoU=False, SIoU=False, EIoU=False, WIoU=False, UIoU=False, Focal=False, alpha=1, gamma=0.5, scale=False, eps=1e-7):
